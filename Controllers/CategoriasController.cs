...
namespace GastosPersonales.Controllers
{
    public class CategoriasController : Controller
    {
        ...
        public async Task<IActionResult> Create([Bind("Id,Nombre,TipoCategoria")] Categoria categoria)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("Id,Nombre,TipoCategoria")] Categoria categoria)
        {
            if (id != categoria.Id)
            {
                return NotFound();
